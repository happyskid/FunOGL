...
int main()
{
    ...
    // Objects
    Model object("models/skull/scene.gltf", false);
    Model light("models/cube/scene.gltf", false);

    glm::vec4 lightColor = glm::vec4(1.0f, 1.0f, 1.0f, 1.0f);
    glm::vec3 lightPos = glm::vec3(1.0f, 1.0f, 0.5f);
    glm::vec3 lightScale = glm::vec3(0.05f, 0.05f, 0.05f);
    glm::mat4 lightModel = glm::mat4(1.0f);
    lightModel = glm::scale(glm::translate(lightModel, lightPos), lightScale);

    glm::vec3 objectPos = glm::vec3(0.0f, 0.0f, 0.0f);
    glm::vec3 objectScale = glm::vec3(0.1f, 0.1f, 0.1f);
    ...
    {   
        ...
        basicShader.setMat4("model", objectModel);
        basicShader.setMat4("camMatrix", camMatrix);
        ...
        skyboxShader.setMat4("camMatrix", camMatrix);
        // skybox cube
        glBindVertexArray(skyboxVAO);
